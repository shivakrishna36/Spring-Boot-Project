...
public class BankAppController {
	...
	public String withdraw(@ModelAttribute Transaction transaction,
			Model model) {
		restTemplate.postForEntity("http://localhost:8088/transactions/withdraw", 
				transaction, null);
		model.addAttribute("message","Success!");
		return "withdrawForm";
	}
	...
	{
		CurrentDataSet dataset = restTemplate.getForObject("http://localhost:8088/transactions/getstatements",CurrentDataSet.class);
